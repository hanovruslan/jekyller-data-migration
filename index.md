...
### * Одни и тот же заказчик, одинаковая версия
...
**Простота реализации**{:.next}
**Богатство настроек + документация**{:.next}
**Интеграция в приложение**{:.next}
...
**Интеграция в приложение**{:.slide-red.next}
...
## Текущий вариант - Doctrine Migrations?
{:.blockquote}
## Оптимальный вариант - Свой поведенческий плагин?
{:.blockquote}
## Заключение

...
- {:.next}Доступные драйверы (2)
- {:.next}Версионирование (1)
- {:.next}Зависимость миграций (1)
- {:.next}Простота подключения (.5)
- {:.next}Богатство настроек + документация (.5)
- {:.next}Интеграция в приложение (.5)
- {:.next}Транзитивные зависимости (.5)
